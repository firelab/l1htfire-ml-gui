  ...
  wellPanel(
           ...
           fluidRow(
             column(width = 6, offset = 0,
               ...
               selectInput("xvar", "X-axis variable", x_axis_vars, width =  "300px",  selected = "bed_slope_angle"),
               selectInput("levvar", "Level variable", x_axis_vars, width ="300px",  selected = "wind_mean"),
               ...
               column(width = 6, offset = 0,
                      ...
                      sliderInput( "fuel_gap_size", "Fuel Gap Size (meters) :", min = min_fuel_gap_size, max =max_fuel_gap_size, value =0.15, step = 0.01),
